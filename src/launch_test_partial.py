...
if __name__ == '__main__':
    ...
    file_path_blue = os.path.abspath('nets/RIAL/ VDN_partial_observation_continuous_Com.pk')
    ...
    red_epsilon = 1
    render = True
    test_name = 'VDN_partial_Qvalues'
    messages_blue, messages_red, cumulative_reward_blue,cumulative_reward_red, n_cycles = runner.demo(N_times, 
                    blue_epsilon, red_epsilon, render, test_name)
    ...
    # scipy.io.savemat('matplot/VDN_partial_observation_Qvalues.mat', {'var_msg': var_msg,'cumulative_reward_blue' : cumulative_reward_blue ,'n_cycles' :n_cycles})
