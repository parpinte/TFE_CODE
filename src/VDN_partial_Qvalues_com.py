...
class Runner():
    ...
    def generate(self, training_team, episode): # take into account the communication 
        ...
        for agent in self.env.agent_iter():
            ...
            #obs['obs'] = list(np.concatenate((obs['obs'][:4], obs['obs'][9:])))
    ...
    def save(self, episode):
        filename = f"VDN_partial_observation_continuous_Com.pk"
    ...
    def train_fromVDN(self, training_team):
        ...
        writer = SummaryWriter('src/runs/VDN_partial_observation_continuouscom')
